...
string Out_path;
char Seq_type = 'T'; // whether it is 2bRAD sequence
...
int printhelp(){
    ...
    cout << "\t[Composition profiling input and parameters]" << endl;
    ...
    cout << "\t  -l 2bRAD sequence files list [Conflicts with -i]" << endl;
    cout << "\t  -L (upper) Species list (each row is a species) [Conflicts with -i and -T]" << endl;
    ...
    cout << "\t[Functional prediction parameter]" << endl;
    cout << "\t  -F (upper) Functional analysis, T(rue) or F(alse), default is T" << endl;
    cout << endl;

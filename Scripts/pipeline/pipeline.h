...
int printhelp(){
    ...
    cout << "\t  -i Sequence files list, 2bRAD or WGS data [Conflicts with -l]" << endl;
    cout << "\t  -p List file path prefix [Optional for -i]" << endl;
    cout << "\tor" << endl;
    cout << "\t  -l 2bRAD sequence files list [Conflicts with -i]" << endl;
    cout << "\t  -T (upper) Input Species-level abundance table generated by 2bRAD-M [Conflicts with -i]" << endl;
    cout << "\t  -p List file path prefix [Optional for -l]" << endl;
    cout << "\tor" << endl;
    cout << "\t  -L Species list (each row is a species) [Conflicts with -i and -l]" << endl;
    cout << "\t  -T (upper) Input Species-level abundance table generated by 2bRAD-M [Conflicts with -i]" << endl;
          ...
          switch(argv[i][1]){
              ...
              case 'l': Taxa_list_file = argv[i+1];
                  if (Step == 0) {
                      ...
                      cerr << "Error: -l conflicts with -L" << endl;
                      exit(0);
                  }
                  else Step = 1;
                  break;

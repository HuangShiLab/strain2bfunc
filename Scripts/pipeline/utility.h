...
string Check_Env(){
    ...
    if (getenv("Strain2bFunc") == NULL){
                               
                               cerr << "Error: Please set the environment variable \"Strain2bFunc\" to the directory" << endl;
                               exit(0);
                               
                                   }
    
    string path =  getenv("Strain2bFunc");
    return path;
...
string Check_2bRADM_Env() {
    if (getenv("RADM") == NULL){
                               ...
                               cerr << "Error: Please set the environment variable \"2bRAD-M\" to the directory" << endl;
                               exit(0);

...
option_list <- list(
	...
	make_option(c("-p", "--min_prevalence"), type = "numeric", default=0.8, help = "Input the minimum percentage of samples within a group where a species must be present to be considered significant [default %default]"), 
